...
class StepOneForm(forms.Form):
    phone = forms.CharField(
        widget=forms.TextInput(attrs={"placeholder": "Wpisz swój numer telefonu.."}),
        initial="+48",
        validators=[RegexValidator(r"^\+48\d{9}$", message="Wpisz poprawny polski numer zaczynający się od +48.")],
    )
